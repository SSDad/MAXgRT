...
if strcmp(data.bMode, 'V')
    fun_Callback_Pushbutton_BodyPanel_SaveContour(data, src, evnt);
else
    fun_Callback_Pushbutton_BodyPanel_SaveContour_Cine(data, src, evnt);
end


    function  fun_Callback_Pushbutton_BodyPanel_SaveContour(data, src, evnt);
...
%         data = guidata(hFig);
    ...
    function  fun_Callback_Pushbutton_BodyPanel_SaveContour_Cine(data, src, evnt);
