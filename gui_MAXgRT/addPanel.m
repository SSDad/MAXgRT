...
%% cine measure view
h_Measure = 0.15;
Panel.Measure_Cine.hPanel = uipanel('parent', hFig,...
                                'Unit', 'Normalized',...
...
% patient info
y0 = 1-h_PtInfo;
Panel.TableMode.PtInfo.hPanel = uipanel('parent', hFig,...
                                'Unit', 'Normalized',...
...
% Table
y0 = y0 - h_Table;
Panel.TableMode.Data.hPanel = uipanel('parent', hFig,...
                                'Unit', 'Normalized',...
...
Panel.TableMode.Table.hPanel = uipanel('parent', hFig,...
                                'Unit', 'Normalized',...
