...
if strcmp(src.Tag, 'Wave')
        ...
        if hRB.Value
            ...
            data.Panel.View_Cine.subPanel(1).ssPanel(3).Comp.hPlotObj.MarkLines.AbMarkPatch.Visible = 'on';
            data.Panel.View_Cine.subPanel(1).ssPanel(3).Comp.hPlotObj.MarkLines.SnakeMarkPatch.Visible = 'on';

            data.Panel.Measure_Cine.Comp.Edit.NoP.Enable = 'on';
%             data.Panel.Measure_Cine.Comp.Text.NoP.Visible = 'on';
        else
            data.Measure_Cine.hFig.Visible = 'off';
...
%             data.Panel.Measure_Cine.Comp.Text.NoP.Visible = 'off';
