function Callback_Togglebutton_BodyPanel_Contour(src, evnt)

global hFig
data = guidata(hFig);
if strcmp(data.bMode, 'V')
    fun_Callback_Togglebutton_BodyPanel_Contour(src, evnt);
else
    fun_Callback_Togglebutton_BodyPanel_Contour_Cine(src, evnt);
end
